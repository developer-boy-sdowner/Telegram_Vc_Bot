...
async def start(_, message: Message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[
            InlineKeyboardButton("➕ Add To Your Group ➕", url="https://t.me/vcmusiclightningbot?startgroup=true")
            ],[
            InlineKeyboardButton("💬 Support Group", url="https://t.me/chattingwithothers"),
            InlineKeyboardButton("Add addistant Manualy", url="https://t.me/")
            ],[
...
@Client.on_message(filters.command(["start", "start@vcmusiclightningbot"]) & ~filters.private & ~filters.channel)
async def gstart(_, message: Message):
      await message.reply_text(
          text="**Music Bot Is Online ✅**",
          reply_markup=InlineKeyboardMarkup(
              [[
              InlineKeyboardButton(text="🎙️ Support Group 🎙️", url="https://t.me/chattingwithothers")
              ]]
          )
      )


@Client.on_message(filters.command(["cmdlist", "start@vcmusiclightningbot"]) & filters.private & ~filters.channel)
